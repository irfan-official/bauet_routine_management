...
function Temp_main({ currentBatch }) {
  ...
  useEffect(() => {
    console.log("Final Form Data", apiData);
    if (apiData.length > 0) {
      axios
        .post(
          "/api/generate_routine",
          { apiData, coursesData },
          {
        ...
        .then((response) => {
          ...
          navigate("/show_routine");
        })
        .catch((error) => {
          console.error("Error generating routine:", error);
          alert(
            `Error: ${
              error.response?.data?.message || "Failed to generate routine!"
            }`
          );
        });
    }
        ...
        <>
          <div className="2xl:w-5/12 xl:w-4/12 h-full flex flex-col gap-6 items-center justify-center ">
            ...
            >
              ...
              {clickAT.clickStatus ? (
                <div className="2xl:scale-[0.89] xl:scale-[0.6] flex flex-col p-3 gap-2 items-center justify-center bg-[#C1C6C4] border border-[#68766F] rounded-lg absolute 2xl:top-16 xl:top-3 z-50 translate-x-[50%] translate-y-[-30%] 2xl:translate-x-[100%] 2xl:translate-y-[-55%] ">
                  <button
                    onClick={() => {
            ...
            >
              ...
              {clickPF.clickStatus ? (
                <div
                  className="2xl:scale-[0.8] xl:scale-[0.6] flex flex-col p-3 gap-2 items-center justify-center bg-[#C1C6C4] 
                   border border-[#68766F] rounded-lg absolute 2xl:top-16 xl:top-3 z-50 translate-x-[45%] translate-y-[-30%] 2xl:translate-x-[88%] 2xl:translate-y-[-97%]"
                >
                  <button
                    onClick={() => {
            ...
            >
              ...
              {clickAP.clickStatus ? (
                <div className="2xl:scale-[0.97] xl:scale-[0.6] flex flex-col p-3 gap-2 items-center justify-center bg-[#C1C6C4] border border-[#68766F] rounded-lg absolute 2xl:top-16 xl:top-3 z-50 translate-x-[95%] translate-y-[-30%] 2xl:translate-x-[157%] 2xl:translate-y-[-52%]">
                  <button
                    onClick={() => {
                      setClickResults_1(setClickAP);
            ...
            >
              ...
              {clickASTP.clickStatus ? (
                <div className="2xl:scale-[0.91] xl:scale-[0.6] flex flex-col p-3 gap-2 items-center justify-center bg-[#C1C6C4] border border-[#68766F] rounded-lg absolute 2xl:top-16 xl:top-3 z-50 translate-x-[90%] translate-y-[-27%] 2xl:translate-x-[155%] 2xl:translate-y-[-41%]">
                  <button
                    onClick={() => {
                      setClickResults_1(setClickASTP);
            ...
            >
              <h2>Lecturer</h2>
              {clickLC.clickStatus ? (
                <div className="2xl:scale-[0.86] xl:scale-[0.6] flex flex-col p-3 gap-2 items-center justify-center bg-[#C1C6C4] border border-[#68766F] rounded-lg absolute 2xl:top-16 xl:top-3 z-50 translate-x-[70%] translate-y-[-65%] 2xl:translate-x-[127%] 2xl:translate-y-[-77%]">
                  <button
                    onClick={() => {
                      setClickResults_1(setClickLC);
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              {checkStatus().status ? (
                <form
                  ...
                  className="flex flex-col items-center justify-center 2xl:scale-[0.9] xl:scale-[0.7] w-full h-full gap-10 relative"
                >
                  ...
                  {confirm ? (
                    <button
                      type="submit"
                      className="text-white w-3/12 py-3 font-semibold rounded-lg bg-orange-500"
                    >
                      GENERATE
                    </button>
                  ) : (
